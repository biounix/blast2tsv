...
# blast2tsv.py --blast blast.tsv --lengths genome.lengths --evalue e-value --extend length --merge --output output.tsv
# blast2tsv.py --blast blast.tsv --lengths genome.lengths --evalue 0.001   --extend 50000  --merge --output output.tsv
...
parser.add_argument('-w', '--window' , metavar = 'window size'   , type = int  , default = 0           , help = 'window length to consider two regions to merge.'                      )
